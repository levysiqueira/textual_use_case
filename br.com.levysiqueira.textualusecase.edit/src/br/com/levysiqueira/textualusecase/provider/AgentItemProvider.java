...
/**
 * This is the item provider adapter for a {@link br.com.levysiqueira.textualusecase.Agent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TextualUseCasePackage.Literals.AGENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addActionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Agent_actions_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Agent_actions_feature", "_UI_Agent_type"),
				 TextualUseCasePackage.Literals.AGENT__ACTIONS,
				 true,
				 false,
				 true,
				 null,
