...
/**
 * This is the item provider adapter for a {@link br.com.levysiqueira.textualusecase.Step} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StepItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAlternativeFlowPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Alternative Flow feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAlternativeFlowPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Step_alternativeFlow_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Step_alternativeFlow_feature", "_UI_Step_type"),
				 TextualUseCasePackage.Literals.STEP__ALTERNATIVE_FLOW,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TextualUseCasePackage.Literals.STEP__NAME,
				 true,
				 false,
				 false,
