...
/**
 * This is the item provider adapter for a {@link br.com.levysiqueira.textualusecase.UseCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UseCaseItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TextualUseCasePackage.Literals.USE_CASE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TextualUseCasePackage.Literals.USE_CASE__ACTOR,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TextualUseCasePackage.Literals.USE_CASE__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TextualUseCasePackage.Literals.USE_CASE__INCLUDES,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TextualUseCasePackage.Literals.USE_CASE__ALTERNATIVE_FLOW);
			childrenFeatures.add(TextualUseCasePackage.Literals.USE_CASE__BASIC_FLOW);
			childrenFeatures.add(TextualUseCasePackage.Literals.USE_CASE__POST_CONDITION);
			childrenFeatures.add(TextualUseCasePackage.Literals.USE_CASE__PRE_CONDITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TextualUseCasePackage.Literals.USE_CASE__ALTERNATIVE_FLOW,
				 TextualUseCaseFactory.eINSTANCE.createAlternativeFlow()));

		newChildDescriptors.add
			(createChildParameter
				(TextualUseCasePackage.Literals.USE_CASE__BASIC_FLOW,
				 TextualUseCaseFactory.eINSTANCE.createBasicFlow()));

		newChildDescriptors.add
			(createChildParameter
				(TextualUseCasePackage.Literals.USE_CASE__POST_CONDITION,
				 TextualUseCaseFactory.eINSTANCE.createCondition()));

		newChildDescriptors.add
			(createChildParameter
				(TextualUseCasePackage.Literals.USE_CASE__PRE_CONDITION,
				 TextualUseCaseFactory.eINSTANCE.createCondition()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == TextualUseCasePackage.Literals.USE_CASE__POST_CONDITION ||
			childFeature == TextualUseCasePackage.Literals.USE_CASE__PRE_CONDITION;
